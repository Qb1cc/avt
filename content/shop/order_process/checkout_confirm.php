...
<div style="overflow: hidden; overflow-x: auto;">
    <table class="table">
		<tr>
			<th style="vertical-align: middle; white-space: nowrap; background-color: beige;">Ваш заказ</th>
			<th style="vertical-align: middle; white-space: nowrap; text-align: right;background-color: beige;">Цена</th>
			<th style="vertical-align: middle; white-space: nowrap; text-align: center;background-color: beige;">Количество</th>
			<th style="vertical-align: middle; white-space: nowrap; text-align: right;background-color: beige;">Сумма</th>
		</tr>
<?php
...
for($i=0; $i < count($cart_records); $i++)
{
    ...
    <tr>
        <td style="vertical-align: middle; width: 100%; min-width: 200px; max-width: 800px; word-wrap: break-word; background-color: ghostwhite;">
            <?php echo $name; ?>
        </td>
        ...
        <td style="vertical-align: middle; white-space: nowrap; text-align: right; background-color: ghostwhite;">
            <?php echo $price; ?>
        </td>
        
        <td style="vertical-align: middle; white-space: nowrap; text-align: center; background-color: ghostwhite;">
...
<div style="margin-bottom: 0px; text-align: right; font-size: 18px; font-weight: bold; color: darkblue;"><span style="font-size: 14px; font-weight: normal;">Итого:</span> <?php echo $price_total; ?></div>
