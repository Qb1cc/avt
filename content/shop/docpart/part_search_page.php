...
var sam_price_time = 'sam_time';//Какая из кнопок была выбрана первой sam_price или sam_time
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="padding:10px 15px;">
          ...
          <b>Выбирете автомобиль, в блокнот которого будет дабавлена позиция</b>
        </div>
