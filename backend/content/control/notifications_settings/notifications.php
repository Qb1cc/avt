	...
	<div class="col-lg-12">
		<div class="hpanel">
			...
			<div class="panel-body">
				...
				print_backend_button( array("background_color"=>"#8e44ad", "fontawesome_class"=>"fas fa-undo", "caption"=>"Вернуть заводские настройки", "href"=>"javascript:void(0);", "onclick"=>"set_default_checked();") );
				?>
